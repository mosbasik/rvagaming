...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
    <head>
        <title>Rift Valley Academy Gaming - Matches</title>
    ...
    <body>
        ...
        <div id="body">
            ...
            <div id="firstline">
                <div>
                    Winrate: <?php printGlobalWinrate(); ?>
                </div>
            </div>
            ...
            <div id="content">
                ...
                <?php
                    ...
                    // if the limit field is empty use 20 by default
                    if(empty($_GET['limit'])) {
                        $limit = 20;
                    } else {
                        $limit = $_GET['limit'];
                    ...
                    printMatchTable($sort, $direction, $limit);
                ?>
