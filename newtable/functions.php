<?php
    ...
    function printMenu($highlight) {
        echo "<div id=\"navigation\">
                  ...
                  </a><a href=\"resources.php\" " . returnSelectState(2, $highlight) . ">Resources
                  </a><a href=\"proscene.php\" "  . returnSelectState(3, $highlight) . ">Pro Scene
                  </a><a href=\"media.php\" "     . returnSelectState(4, $highlight) . ">Media
                  </a><a href=\"technical.php\" " . returnSelectState(5, $highlight) . ">Technical Info
                  </a><a href=\"forums.php\" "    . returnSelectState(6, $highlight) . ">Forums
                  </a><a href=\"links.php\" "     . returnSelectState(7, $highlight) . ">Links</a>
              </div>";
    }
