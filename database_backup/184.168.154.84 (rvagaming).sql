...
INSERT INTO `VIEWS` VALUES(NULL, 'rvagaming', 'User Page', '/* ALGORITHM=UNDEFINED */ select `rvagaming`.`justpeople`.`personkey` AS `personkey`,`rvagaming`.`justpeople`.`fullname` AS `fullname`,`rvagaming`.`facebook`.`facebookid` AS `facebookid`,`rvagaming`.`steamdotabuff`.`steamname` AS `steamname`,`rvagaming`.`steamdotabuff`.`steamid` AS `steamid`,`rvagaming`.`steamdotabuff`.`dotabuffid` AS `dotabuffid`,`s1`.`matchforeignkey` AS `matchforeignkey` from (((`rvagaming`.`peoplematchesheroes` `s1` join `rvagaming`.`justpeople` on((`rvagaming`.`justpeople`.`personkey` = `s1`.`personforeignkey`))) join `rvagaming`.`facebook` on((`rvagaming`.`justpeople`.`personkey` = `rvagaming`.`facebook`.`personforeignkey`))) join `rvagaming`.`steamdotabuff` on((`rvagaming`.`justpeople`.`personkey` = `rvagaming`.`steamdotabuff`.`personforeignkey`))) where (`s1`.`matchforeignkey` = (select max(`s2`.`matchforeignkey`) AS `MAX(s2.matchforeignkey)` from `rvagaming`.`peoplematchesheroes` `s2` where (`s1`.`personforeignkey` = `s2`.`personforeignkey`))) order by `s1`.`matchforeignkey` desc', 'NONE', 'YES', 'rvagaming@%', 'DEFINER');
INSERT INTO `VIEWS` VALUES(NULL, 'rvagaming', 'match_winrate', '/* ALGORITHM=UNDEFINED */ select `t`.`total` AS `total`,`w`.`won` AS `won`,round(((`w`.`won` * 100.0) / `t`.`total`),1) AS `rate` from (`rvagaming`.`total_matches` `t` join `rvagaming`.`won_matches` `w`)', 'NONE', 'YES', 'rvagaming@%', 'DEFINER');
INSERT INTO `VIEWS` VALUES(NULL, 'rvagaming', 'total_matches', '/* ALGORITHM=UNDEFINED */ select count(`rvagaming`.`matches`.`id`) AS `total` from `rvagaming`.`matches`', 'NONE', 'NO', 'rvagaming@%', 'DEFINER');
INSERT INTO `VIEWS` VALUES(NULL, 'rvagaming', 'won_matches', '/* ALGORITHM=UNDEFINED */ select count(`rvagaming`.`matches`.`id`) AS `won` from `rvagaming`.`matches` where (`rvagaming`.`matches`.`outcome` = _utf8''Win'')', 'NONE', 'NO', 'rvagaming@%', 'DEFINER');
...
CREATE ALGORITHM=UNDEFINED DEFINER=`rvagaming`@`%` SQL SECURITY DEFINER VIEW `rvagaming`.`User Page` AS select `rvagaming`.`justpeople`.`personkey` AS `personkey`,`rvagaming`.`justpeople`.`fullname` AS `fullname`,`rvagaming`.`facebook`.`facebookid` AS `facebookid`,`rvagaming`.`steamdotabuff`.`steamname` AS `steamname`,`rvagaming`.`steamdotabuff`.`steamid` AS `steamid`,`rvagaming`.`steamdotabuff`.`dotabuffid` AS `dotabuffid`,`s1`.`matchforeignkey` AS `matchforeignkey` from (((`rvagaming`.`peoplematchesheroes` `s1` join `rvagaming`.`justpeople` on((`rvagaming`.`justpeople`.`personkey` = `s1`.`personforeignkey`))) join `rvagaming`.`facebook` on((`rvagaming`.`justpeople`.`personkey` = `rvagaming`.`facebook`.`personforeignkey`))) join `rvagaming`.`steamdotabuff` on((`rvagaming`.`justpeople`.`personkey` = `rvagaming`.`steamdotabuff`.`personforeignkey`))) where (`s1`.`matchforeignkey` = (select max(`s2`.`matchforeignkey`) AS `MAX(s2.matchforeignkey)` from `rvagaming`.`peoplematchesheroes` `s2` where (`s1`.`personforeignkey` = `s2`.`personforeignkey`))) order by `s1`.`matchforeignkey` desc;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`rvagaming`@`%` SQL SECURITY DEFINER VIEW `rvagaming`.`match_winrate` AS select `t`.`total` AS `total`,`w`.`won` AS `won`,round(((`w`.`won` * 100.0) / `t`.`total`),1) AS `rate` from (`rvagaming`.`total_matches` `t` join `rvagaming`.`won_matches` `w`);
...
CREATE ALGORITHM=UNDEFINED DEFINER=`rvagaming`@`%` SQL SECURITY DEFINER VIEW `rvagaming`.`total_matches` AS select count(`rvagaming`.`matches`.`id`) AS `total` from `rvagaming`.`matches`;
...
CREATE ALGORITHM=UNDEFINED DEFINER=`rvagaming`@`%` SQL SECURITY DEFINER VIEW `rvagaming`.`won_matches` AS select count(`rvagaming`.`matches`.`id`) AS `won` from `rvagaming`.`matches` where (`rvagaming`.`matches`.`outcome` = _utf8'Win');
