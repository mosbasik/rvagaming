<?php
    ...
    function printMenu($highlight) {
        echo "<div id=\"navigation\">
                  ...
                  </a><a href=\"links.php\" "     . returnSelectState(8, $highlight) . ">Links
                  </a><a href=\"register.php\" "  . returnSelectState(9, $highlight) . ">Register</a>
              </div>";
    }
    ...
    /*
     * Sanitizes untrusted data and returns cleaned version
     */
    function test_input($data) {
        //$data = trim($data); //removes leading and trailing spaces
        //$data = stripslashes($data); //removes any slashes
        //$data = htmlspecialchars($data); //converts special chars to html code
        return $data;
    }
?>
